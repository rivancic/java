...
public class SearchMethods {
  ...
  public void findFirst() {
    ...
    Optional<String> firstElement = Streams.getNamesStream().findFirst();
  ...
  public void findAny() {
    ...
    Optional<String> firstElement = Streams.getNamesStream().findAny();
    assertEquals(true, firstElement.isPresent());
    assertEquals(true, firstElement.get().length() > 0);
  }
  ...
  public void anyMatch() {
    boolean doesAnyNameStartsWithP =
      Streams.getNamesStream().anyMatch(name -> name.startsWith("P"));
  ...
  public void nonMatch() {
    boolean noNameIsStartingWIthMir =
      Streams.getNamesStream().noneMatch(name -> name.startsWith("Mir"));
  ...
  public void allMatch() {
    boolean allNamesLongerThan5Characters =
      Streams.getNamesStream().allMatch(name -> name.length() > 4);
