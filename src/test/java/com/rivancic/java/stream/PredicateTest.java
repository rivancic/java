...
public class PredicateTest {
  ...
  /**
   * Even more effective would be te usage of
   * {@link Stream#mapToInt(java.util.function.ToIntFunction)} and {@link ToIntFunction}.
   * 
   * @throws Exception
   */
  @Test
  public void unaryOperatorTest() throws Exception {
    UnaryOperator<Integer> addTenK = n -> n * 10000 + 10000;
    Stream<Integer> years = Stream.of(1, 2, 3, 4, 5);
    List<Integer> savings = years.map(addTenK).collect(Collectors.toList());
    assertEquals(Integer.valueOf(50000), savings.get(3));
  }
}
