...
public class PeekTest {
  ...
  @Test
  public void peekWithAnyMatch() throws Exception {

    Stream<String> cities = Stream.of("Las Vegas", "Los Angeles", "Chicago", "New York");

    System.out.println(
      cities.peek(c -> System.out.println(c)).anyMatch(c -> c.contains("y") == false));
  }
