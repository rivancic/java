...
public class ListTest {
	...
	/**
	 * The approach of how to remove items from the list if we know the value of the
	 * item that we want to remove but not the index itself.
	 */
	@Test
	...
	/**
	 * Won't remove any of the values from the list. Because newly created Student
	 * object is not equal to any other student item inside of the list. If we would
	 * want to use removal method this way we would need to override equals and
	 * hashCode methods of Student class. Or use reference to the items in the list.
	 */
	@Test
